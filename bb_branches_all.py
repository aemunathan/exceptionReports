...
def get_last_commit(project_key, repo_slug, branch_name, latest_commit_hash=None):
    ...
    (blank fields if nothing resolvable)
    """
    # Primary: by branch name
    ...
    # Fallback: by latest commit hash (from the branch listing)
