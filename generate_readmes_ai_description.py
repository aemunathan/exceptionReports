...
def get_code_summary(repo_path):
    # Collect a few config/code files (just paths)
    candidates = []
    ...
    prompt = "Based on the following source or configuration file content, summarize the purpose of this application in 2-3 lines in a professional tone.\n\n"
