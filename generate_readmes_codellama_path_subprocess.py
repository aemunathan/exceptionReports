...
BASE_DIR = os.path.expanduser("~/java-projects")  # Update this to your repos base dir
RETRY_LIMIT = 2
README_LOG = os.path.join(BASE_DIR, "readme_codellama_subprocess_log.txt")
...
def call_codellama_via_subprocess(prompt):
    try:
...
"""".strip()
    ...
    model_response = call_codellama_via_subprocess(prompt)
