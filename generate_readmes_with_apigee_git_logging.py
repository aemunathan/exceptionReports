...
def generate_readme(repo_path):
    log_path = os.path.join(repo_path, "README.log")
    with open(log_path, "w") as log:

        readme_path = os.path.join(repo_path, "README.md")
        if os.path.exists(readme_path):
            log.write(f"README already exists in {repo_path}\n")
            return
        ...
        log.write(f"README.md generated in {repo_path}\n")
